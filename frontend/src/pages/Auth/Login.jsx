        ...
        <div class="row justify-content-center">
          <div class="col-md-8 col-lg-6 col-xl-5">
                ...
                <div class="p-2">
                  <form class="form-horizontal">
                    ...
                    <div class="mt-3 d-grid">
                      <button class="btn btn-primary waves-effect waves-light" style={{backgroundColor: '#3b82f6'}} type="submit" onClick={handleSubmit}>
                        {loading ? (
            ...
            <div class="mt-5 text-center">
              <div>
                <p>Don't have an account ? <a href="#" class="fw-medium text-primary"> Contact EMR Focal Person </a> </p>
              </div>
            </div>
          </div>
        </div>
