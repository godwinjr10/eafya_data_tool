create view reporting."105_02_hpv_vaccination" as
SELECT
...
FROM (
  ...
  WHERE vaccine_id IN (SELECT mapping_id FROM reporting.customizationset where name ilike '%hpv vaccine%' and mapping_id > 0)
