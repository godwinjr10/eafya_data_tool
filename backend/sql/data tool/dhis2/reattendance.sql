...
JOIN (SELECT DISTINCT section_id, section_name, hmis_code, hmis_name FROM reporting.dhis_eafya_mapping_conditions WHERE section_id = '1.1' 
AND hmis_code = 'OA02') m ON 1=1 WHERE 1=1